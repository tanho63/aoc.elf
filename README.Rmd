...
[![Dev status](https://img.shields.io/github/r-package/v/tanho63/aoc.elf/master?label=version&style=flat-square&logo=github)](https://github.com/tanho63/aoc.elf)
<!-- badges: end -->

The goal of aoc.elf is to provide helper functions for [Advent of Code](https://adventofcode.com) solutions in R.
...
You can find the cookie value here ![](https://i.imgur.com/IHEBzAe.png) in your network tab. 
